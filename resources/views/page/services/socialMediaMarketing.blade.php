...
@section('content')
	<!-- Stunning Header -->
	<div class="stunning-header bg-social">
		<div class="stunning-header-content">
			<h1 class="stunning-header-title">Marketing en Redes Sociales</h1>
			<ul class="breadcrumbs">
				...
				<li class="breadcrumbs-item active">
					<span href="#">Marketing en Redes Sociales</span>
					<i class="seoicon-right-arrow"></i>
				</li>
			</ul>
		</div>
	...
	<div class="container-fluid">
		<div class="row medium-padding80 bg-border-color">
			<div class="container heading mb30 align-center">
				<h4 class="h1 heading-title c-brand-p">Categorías</h4>
			...
			<div class="pricing-tables pricing-tables-head bg-white-color">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-padding">
							<div class="pricing-tables-item">
								<div class="pricing-head bg-secondary-social"></div>
								<div class="pricing-content-wrap">
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-padding">
							...
							<div class="pricing-tables-item">
								...
								<div class="pricing-head bg-primary-social"></div>
