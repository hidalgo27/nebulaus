...
@section('headBlog')
	<div class="stunning-header stunning-header-bg-lightviolet">
		<div class="stunning-header-content">
			<h1 class="stunning-header-title">¿Cómo empezar mi tienda virtual?</h1>
		...
		<div class="post__content">
			...
			<div class="post__content-info">
				<div class="pb30 align-justify">
					<img class="pb30" loading="lazy" src="img/blog/tienda-virtual.jpg" alt="seo">
					<p class="c-dark">
					...
					<p class="c-dark">
						Es por esto que La agencia de marketing nébula te trae una guía sencilla y concisa con los pasos que debes seguir para empezar con tu tienda virtual.
                    </p>
				</div>
				<div class="pb30 align-justify">
					<div class="heading">
						<h2 class="h4 heading-title">Selecciona una plataforma para crear el e-commerce</h2>
					...
					<p class="c-dark">
						Muchas plataformas donde puedes crear un sitio web. Sin embargo, no todas permiten que de tu sitio hagas una tienda online. Para tener un e-commerce es necesario que la plataforma que uses tenga la posibilidad de añadir un carrito.    
                    </p>
				</div>
				<div class="pb30 align-justify">
					<div class="heading">
						<h2 class="h4 heading-title">Verifica el servicio de hosting y cámbialo de ser necesario</h2>
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
				...
				<div class="pb30 align-justify">
					<div class="heading">
						<h2 class="h4 heading-title">Escoge un nombre de dominio relacionado con el negocio</h2>
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
				...
				<div class="pb30 align-justify">
					<div class="heading">
						<h2 class="h4 heading-title">Ocúpate del diseño</h2>
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
				...
				<div class="pb30 align-justify">
					<div class="heading">
						<h2 class="h4 heading-title">Haz un apartado de “Preguntas Frecuentes”</h2>
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
				...
				<div class="pb30 align-justify">
					<div class="heading">
						<h2 class="h4 heading-title">Configura la pasarela de pago</h2>
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
				...
				<div class="pb30 align-justify">
					<div class="heading">
						<h2 class="h4 heading-title">Sube los productos al sitio de forma detallada</h2>
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
				...
				<div class="pb30 align-justify">
					<div class="heading">
						<h2 class="h4 heading-title">Realiza el lanzamiento del sitio apoyándote en las redes sociales</h2>
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
				...
				<div class="pb30 align-justify">
					<div class="heading">
						<h2 class="h4 heading-title">Aumenta el tráfico a través de publicidad digital</h2>
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
