			...
			<div class="post__content-info">
				...
				<div class="pb30">
					...
					<ul class="c-dark">
						...
						<li>Con vídeos permites que las personas se sientan cómodas y ahorren tiempo, a través del mismo puedes comunicar mucho más en menos tiempo que a diferencia de un largo texto.</li>
						<li>Puedes hacer un vídeo de cualquier cosa: educación, información, comercial, social, de diversión, etc.</li>
						<li>Ganas más confianza y credibilidad, ya sea con vídeo orgánico o de Ads. Las personas confían más al saber que hay una persona real detrás de cada marca o negocio.</li>
				...
				<div class="pb30">
					...
					<ul class="c-dark">
						...
						<li>
							Mantienes tu cerebro ocupado con toda la información que vas procesando, porque todo lo que dice la persona del otro lado lo vas recreando.
						</li>
						<li>
							En su mayoría son de fácil acceso y gratuito, es decir: formación gratuita.
						</li>
						<li>
							No tienes un horario establecido, porque puedes ir y escucharlo cuando tú puedas.
						</li>
					</ul>
				</div>						
			</div>
