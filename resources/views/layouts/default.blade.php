...
<html lang="en">
    <head lang="en">
        ...
        <meta property="og:url" content="https://nebulaperu.com/"/>
        <meta property="og:image" content="https://nebulaperu.com/img/nebula-portada.jpg" />
            ...
            <div class="popup right-menu">
                ...
                <div class="widget contacts">
                    ...
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">info@nebulaperu.com</a>
                        ...
                        <div class="row">
                            <div class="subscribe scrollme">
                                <div class="col-lg-6 col-lg-offset-5 col-md-6 col-md-offset-5 col-sm-12 col-xs-12">
                                    ...
                                    <form  method="POST" action="{{route('enviarOfertas')}}">
                                        @csrf
                                        <input class="input-standard-grey input-white" name="tEmail" placeholder="Tu email" type="email" required>
                                        <div class="row align-center">
                                            <button class="btn btn-medium btn--olive btn-hover-shadow" type="submit">¡Únete!
                                            </button>
                                        </div>
                                    </form>
                                </div>
