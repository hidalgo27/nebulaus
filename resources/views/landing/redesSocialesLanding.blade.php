        ...
        <div class="container ">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 align-center">
                    <img loading="lazy" src="img/social-photo.png" alt="creacion de logo">
                </div>
            </div>
        </div>
    </div>
	...
	<div class="container medium-padding80">
		...
		<div class="row">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<h2 class="h5 uppercase align-center bold c-primario">Nuestro Servicios en Redes Sociales 2021</h2>
						<ul class="cat-list align-center sorting-menu">
							<li class="cat-list__item active" data-filter="*"><a href="#" class="">Todos</a></li>
							<li class="cat-list__item" data-filter=".crear"><a href="#" class="">Creación de cotenidos</a></li>
							<li class="cat-list__item" data-filter=".admi"><a href="#" class="">Administración y monitoreo</a></li>
							<li class="cat-list__item" data-filter=".publi"><a href="#" class="">Publicidad facebook Ads</a></li>
						</ul>
